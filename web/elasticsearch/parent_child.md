...
Parent and child docs son docs diferentes.
...
Company es el parent de employee.
Solo se puede definir un join field,p ero ese join field puede definir varias relaciones.
...
Podemos poner "inner_hits" para obtener que child ha hecho el match
