...
# Delegate fencing http://clusterlabs.org/doc/en-US/Pacemaker/1.1-plugin/html/Clusters_from_Scratch/_configuring_cman_fencing.html
...
# Para generar entropia: tar zx / > /dev/null
...
/etc/sysconfig/cman:
MAN_QUORUM_TIMEOUT=0 # Deberemos quitar la necesidad de quorum, ya que con dos nodos no podemos lograrlo
