...
La idea es que cuando el resolver de ACME va al dominio \_acme-challenge.foo.bar, va a ver que es un CNAME y va a seguirlo como un link, resolviendo en el dominio apuntado.
