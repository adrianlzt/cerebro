...
NOTA los navegadores pueden bajarse automáticamente certificados intermedios:
<https://github.com/curl/curl/discussions/14009>
mirar aia.md

Este parece el más completo. También nos dice si el chain de certs es completo
pacman -S testssl.sh
testssl foo.com

Nos lista los ciphers configurados:
nmap --script ssl-enum-ciphers -p 443

Nos genera un reporte TLS, ciphers, etc.
sslscan --show-certificates foo.com
...
Chequear si el certificado (cert.cer) esta firmado por myca.pem (CApath a /dev para que no use la del sistema)
openssl verify -CApath /dev -CAfile myca.pem /tmp/cert.cer
