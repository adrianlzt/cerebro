...
failed_when: - zbx_host_register_result.failed - '"Host cannot have more than one default interface of the same type" not in zbx_host_register_result.msg'
...
Parar todo el playbook si cualquier nodo falla (poner en el ansible.cfg o en el playbook, a la altura de "hosts")
