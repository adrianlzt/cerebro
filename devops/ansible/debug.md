...
Ir a ~/.ansible/tmp
Tendremos un fichero XXX (nombre del modulo) y un fichero command.

El fichero setup (obtener facts del host):
...
cd debug_dir
cat args | PYTHONPATH=. python ansible_module_XXX.py
