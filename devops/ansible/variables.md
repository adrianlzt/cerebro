...
inventory group_vars/_ [3]

playbook group_vars/_ [3]

inventory file or script host vars [2]

inventory host_vars/_ [3]

playbook host_vars/_ [3]
...
A veces puede haber problemas porque queremos sacar una variable en formato int pero nos la pinta como string.

<https://forum.ansible.com/t/string-being-submitted-when-it-should-be-an-integer/4800/6>

El truco parece que es pasar lo que queremos como un json para que lo parsee:
