...
si ponemos !all aun tendremos unos cuanto de ansible\_\*, los del subset "min"
...
Y luego poner un primer play que solo haga esto. O un pre_tasks: - name: obtener facts
