...
número de tuplas:
select relname,reltuples from pg*class WHERE relname like 'history_2018_05*%' order by relname;
...
Por cada cosa que hacemos se va sumando el coste (vacuum*cost_page*\*) hasta llegar al autovacuum_vacuum_cost_limit, entonces todos los vacuum workers duermen autovacuum_vacuum_cost_delay
